...
function mroinfo_styles_scripts() {
	...
	wp_enqueue_script( 'boostrap_script', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array( 'jquery' ), '3.0.1', true );
	    ...
	    // Loads JavaScript file for Easing.
	wp_enqueue_script( 'easing_script', get_template_directory_uri() . '/assets/js/jquery.easing.1.3.js', array( 'jquery' ), '1.3', true );
...
function mroinfo_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		<div class="nav-links">
			...
			<?php previous_post_link( '%link', _x( '<span class="glyphicon glyphicon-chevron-left">', '', 'mroinfo' ) ); ?>
			<?php next_post_link( '%link', _x( '<span class="glyphicon glyphicon-chevron-right">', '', 'mroinfo' ) ); ?>
