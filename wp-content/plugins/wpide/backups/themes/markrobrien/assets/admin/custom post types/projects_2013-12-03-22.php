...
$character_one = '<img src="'.get_template_directory_uri().'/assets/img/testimonial-chick.png"/>';
	...
	$meta_boxes[] = array(
		...
		'fields'     => array(
            ...
            array(
                                ...
                                'type'    => 'radio_inline',
                                'options' => array(
                                        array( 'name' => __( ''.$character_one.'', 'cmb' ), 'value' => 'standard', ),
